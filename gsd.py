...
# Load YOLO model
model = YOLO('c:/Users/Hemhalatha V R/Downloads/best_model_in_the_world.pt')  # replace with custom model if needed
...
image_width_px = frame.shape[1] #(height,width,channels)
